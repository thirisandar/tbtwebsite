            ...
            <div className="w-full max-w-5xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden mt-8 border-4 border-gray-200">
                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-8">
                    ...
                    <div className="pt-6 mt-3">
                        ...
                        <button
                            type="submit"
                            className="w-auto sm:w-1/2 mx-auto p-3 flex justify-center border border-transparent cursor-pointer rounded-lg shadow-lg text-xl font-extrabold text-black bg-blue-300 hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-offset-2 focus:ring-blue-500/50 transition duration-200 transform hover:scale-[1.01]"
                        >
                            Submit Registration
                        </button>
                    </div>
